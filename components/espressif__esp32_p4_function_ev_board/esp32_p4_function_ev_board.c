...
#define BSP_HAS_USB_HOST 1
#else
#define BSP_HAS_USB_HOST 0
#endif
...
esp_err_t bsp_display_new_with_handles(const bsp_display_config_t *config, bsp_lcd_handles_t *ret_handles)
{
    ...
    esp_lcd_dpi_panel_config_t dpi_config = ST7701_480_360_PANEL_60HZ_DPI_CONFIG(BSP_LCD_COLOR_FORMAT);
    ...
    esp_lcd_dpi_panel_config_t dpi_config = ILI9881C_800_1280_PANEL_60HZ_DPI_CONFIG_CF(BSP_LCD_COLOR_FORMAT);
    dpi_config.num_fbs = CONFIG_BSP_LCD_DPI_BUFFER_NUMS;
...
esp_err_t bsp_usb_host_start(bsp_usb_host_power_mode_t mode, bool limit_500mA)
{
    ...
    (void)mode;
    (void)limit_500mA;
    ESP_LOGW(TAG, "USB host not supported in this ESP-IDF build");
